...
## 📖 คู่มือการใช้งานระบบสำหรับผู้ใช้ทั่วไปและลูกค้า (User Manual)

* 📄 **[USER_MANUAL.md (คู่มือการใช้งานระบบฉบับสมบูรณ์)](file:///Users/surachartlimrattanaphun/Desktop/PFS/deliverables/USER_MANUAL.md):** คู่มือการใช้งานภาษาไทยเข้าใจง่าย ออกแบบมาสำหรับผู้ที่ไม่มีพื้นฐานด้านเว็บเทคโนโลยี พร้อมภาพจำลองหน้าจอและตัวเลขชี้บอกตำแหน่งปุ่ม (Callouts) อย่างละเอียด ครอบคลุมทั้งฝั่งนักศึกษา (Student), อาจารย์/ผู้ดูแล (Admin) และผู้เข้าชมทั่วไป (Visitor)
* 🖼️ **ภาพประกอบคู่มือ (Visual Assets):** อยู่ในโฟลเดอร์ [`deliverables/manual-assets/`](file:///Users/surachartlimrattanaphun/Desktop/PFS/deliverables/manual-assets/)
